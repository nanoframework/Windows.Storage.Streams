...
namespace Windows.Storage.Streams
{
    ...
    public sealed class DataReader : MarshalByRefObject, IDisposable, IDataReader
    {
        ...
        {
            var chars = new Char[codeUnitCount];
            Encoding.UTF8.GetDecoder().Convert(_buffer.Data, 0, IncreaseReadPosition((int)codeUnitCount), chars, 0, (int)codeUnitCount, false, out Int32 bytesUsed, out Int32 charsUsed, out Boolean completed);
