...
{
    # update dependencies for class libraries that depend Windows.Storage.Streams, mscorlib and others
    ...
    $librariesToUpdate =    ("lib-Windows.Devices.SerialCommunication", 
                            "lib-Windows.Storage")
